...
const PRESET_LEVELS = {
  1: {
    name: "Nivel 1: El Almacén Central",
    rows: 11, cols: 14,
    grid: [
      ['W','W','W','W','W','W','W','W','W','W','W','W','W','W'],
      ['W','T','F','T','F','F','W','F','F','F','F','F','W','W'],
      ['W','T','F','T','F','F','W','F','B','F','F','B','F','W'],
      ['W','T','F','T','F','F','F','B','W','W','W','F','F','W'],
      ['W','T','F','T','F','F','W','F','P','F','F','F','F','W'],
      ['W','T','F','T','F','F','W','W','W','B','W','F','F','W'],
      ['W','W','W','F','W','W','W','F','F','B','F','F','F','W'],
      ['W','F','F','F','F','F','W','F','B','F','B','F','W','W'],
      ['W','F','B','F','F','F','F','B','F','B','F','F','W','W'],
      ['W','F','F','F','F','F','W','F','F','F','F','F','W','W'],
      ['W','W','W','W','W','W','W','W','W','W','W','W','W','W']
    ]
  },
  2: {
    name: "Nivel 2: Canales de Distribución",
    rows: 10, cols: 15,
    grid: [
      ['W','W','W','W','W','W','W','W','W','W','W','W','W','W','W'],
      ['W','F','F','F','F','F','W','F','F','F','F','F','P','W','W'],
      ['W','F','F','F','F','F','W','F','B','F','B','F','F','W','W'],
      ['W','F','F','F','F','F','W','F','B','F','F','B','F','W','W'],
      ['W','F','F','F','F','F','F','F','B','F','B','F','F','W','W'],
      ['W','W','W','W','W','W','W','F','B','F','F','F','F','W','W'],
      ['W','T','T','T','T','F','W','F','B','W','W','F','F','W','W'],
      ['W','F','T','T','T','F','F','B','F','F','B','F','F','W','W'],
      ['W','T','T','T','F','F','W','F','F','B','F','F','F','W','W'],
      ['W','W','W','W','W','W','W','W','W','W','W','W','W','W','W']
    ]
  },
  3: {
    name: "Nivel 3: El Gran Reto de Cajas",
    rows: 10, cols: 13,
    grid: [
      ['W','W','W','W','W','W','W','W','W','W','W','W','W'],
      ['W','T','F','T','F','W','F','F','F','P','F','W','W'],
      ['W','T','F','T','F','F','F','F','B','B','F','W','W'],
      ['W','T','F','T','F','W','F','F','F','B','F','W','W'],
      ['W','T','F','T','F','W','F','F','F','B','F','W','W'],
      ['W','T','F','T','F','W','B','F','B','F','F','W','W'],
      ['W','W','W','F','W','W','F','B','F','F','F','W','W'],
      ['W','F','F','F','F','F','F','F','B','F','B','F','W','W'],
      ['W','F','F','F','F','W','B','F','F','B','F','F','W','W'],
      ['W','W','W','W','W','W','W','W','W','W','W','W','W']
    ]
  }
};
